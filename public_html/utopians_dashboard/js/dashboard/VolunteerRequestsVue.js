...
methods :
{
	...
	fetch: function() {
   // grid.tableButtons='student_list'
		grid.errors = [];
		url = 'Volunteer_Requests_list';
		...
		grid.columns = [
                          ...
                          
                         {
                          ...
                          },
                          {
                           ...
                           {
                              label: 'سبب رغبة التطوع بالقسم',
                              field: 'dept_reason',
                              filterable: true,
                          },
                          {
                              label: 'سبب رغبة التطوع بالمبادرة',
...
fetchFB: function() {
  ...
  student_group_list: function() {
    grid.tableButtons='student_group_list'
    grid.errors = [];

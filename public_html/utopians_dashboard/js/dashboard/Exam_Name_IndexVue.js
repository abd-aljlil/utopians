...
methods :
{
  ...
  Insert_Exam_Name_Index_Questions: function() {
    ...
    formData.append('question_order', grid.question_order);
  ...
  Get_Questions_data: function(id,name,percent,type) {
    ...
    axios.get(url).then( function (response)  {
      ...
      grid.question_order= response.data.count +1;
      console.log(grid.question_order);
      grid.table_buttons = 'Exam_Name_Index_Questions';
    })
    grid.columns = [
                          {
  ...
  SetQuestionsLastorder: function(id) {
    grid.errors = [];
    url         = 'Exam_Name_Index_Questions/' + id + '/edit';
    grid.Exam_Name_Index_Id = id
    axios.get(url).then( function (response)  {
      ...
      $.each(grid.Questions, function( index, value ) {
        ...
        arrr[index]=parseInt(grid.Questions[index].question_order);
        //console.log(arrr);
      });
      var mv =Math.max.apply(Math, arrr);
       grid.question_order= mv;
      console.log(mv+1);
  ...
  Fetch_level_setting_exam_percent: function(id) {
    ...
    getOneQuestionDetails: function(id) {
      ...
      axios.get(url).then( function (response)  {
        ...
        grid.question_order    = response.data.QuestionData.question_order;
    ...
    this.insertingdata = ({
                            ...
                            text               : grid.text,
                            question_order     : grid.question_order,
    ...
    getExamIndexdata: function(id) {
      ...
      axios.get(url).then( function (response)  {
        ...
        grid.course_id    = response.data.RecordData.course_id;

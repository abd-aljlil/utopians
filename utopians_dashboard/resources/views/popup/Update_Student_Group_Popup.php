<div class="modal fade" id="Update_Student_Group_Popup" tabindex="-1" role="dialog" aria-labelledby="popupWinUpdateLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="popupWinUpdateLabel">نقل الطالب إلى مجموعة أخرى</h5>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" id="closeupdateGroupAttendee" data-dismiss="modal">إلغاء</button>
        <button type="button" class="btn btn-warning" @click="updateStudentGroup">حفظ</button>
      </div><!--.modal-footer -->
    </div><!--.modal-content -->
  </div><!--.modal-dialog -->
</div><!--.modal -->
...
<div class="modal fade" id="Insert_Exam_Name_Index_Questionspopup">
  <div class="modal-dialog" role="document">

    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="popupWinLabel">إضافة سؤال امتحاني</h5>
        ...
        <div class="row ">
            ...
            <div class="col-md-10">
              <div class="form-group" v-if="Question_Types_Id['label']=='صورة'">
                ...
                <input type="file" class="form-control" id="recipient-name" ref="UploadFile" @change="handleFileUpload">

<div id="grid">
    ...
    <td style="text-align: center; ">
        <button type="button" class="btn btn-add btn-sm" data-toggle="modal" @click="getdata(props.row.id)" data-target="#updatepopup" data-whatever="@mdo"> <i class="fa fa-edit"></i>تعديل</button>
    </td>

...
<div class="wrapper rtl row" id="wrapper" style="text-align:right;" >
...
<form method="POST" enctype="multipart/form-data" action="updateacceptvolunteer">
        ...
        <br><h3 id="ar">قبول طلب الـتـطــوع</h3>
                ...
                <div class="six_section">
                  <div id="ar" class="section_name"> بيانات قبول طلبات المتطوع </div>
                      <div class="form-holder">
                          ...
                          <select class="form-control" name="Accepting_Status" id="Accepting_Status" required>

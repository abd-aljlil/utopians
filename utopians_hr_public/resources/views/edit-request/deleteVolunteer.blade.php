...
<form method="POST" enctype="multipart/form-data" action="updatedeletevolunteer">
          @csrf
        ...
        <br><h3 id="ar"> حذف بيانات المتطوع بشكل كامل</h3>
        <div> <input name="id" value="{{ $volunteer->id }}" hidden /> </div>
    
        <div class="section">
                <div class="six_section">
                  <div id="ar" class="section_name"> بيانات حذف المتطوع </div>
                      <div class="form-holder">
                          <label id="ar"><b> القسم الذي كان مقبول المتطوع به</b> </label>
                          <input type="text" class="form-control" name="Accepting_Status" id="Accepting_Status" value="{{$st->Accepting_Status}}" required>
                    </div>
					<div class="form-holder">
                        <label id="ar"><b>  تاريخ المتطوع في المبادرة </b></label>
                        <span class="lnr lnr-indent-increase"></span>
                        <div name="Volunteer_History" required>{!! $st->Volunteer_History !!}</div>
                    </div>
                    <div class="form-holder">
                        <label id="ar"><b> ملاحظات </b></label>
                        <span class="lnr lnr-indent-increase"></span>
                        <input type="text" class="form-control" name="Notes" value="لا يوجد">{!! $st->Notes !!}
                    </div>
                </div>
            </div>
        ...
        <div class="section">
            <div class="six_section">
              <div id="ar" class="section_name"> بيانات قبول طلبات المتطوع </div>
                  <div class="form-holder">
                      <label id="ar"><b> القسم المقبول التطوع به</b> </label>
                      <input type="text" class="form-control" name="Accepting_Status" id="Accepting_Status" value="{{ $volunteer->Accepting_Status }}" readonly/>
                </div>
                <div class="form-holder">
                    <label id="ar"><b>  تاريخ المتطوع في المبادرة </b></label>
                    <span class="lnr lnr-indent-increase"></span>
                    <div name="Volunteer_History" required>{!! $volunteer->Volunteer_History !!}</div>
                </div>
                <div class="form-holder">
                    <label id="ar"><b> ملاحظات </b></label>
                    <span class="lnr lnr-indent-increase"></span>
                    <input type="text" class="form-control" name="Notes" value="لا يوجد">{!! $volunteer->Notes !!}
                </div>
            </div>
        </div>

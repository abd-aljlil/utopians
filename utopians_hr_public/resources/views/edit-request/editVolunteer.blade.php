...
<form method="POST" enctype="multipart/form-data" action="updatevolunteer">
          @csrf
        ...
        <h3 id="ar">تعديل طلب الـتـطــوع</h3>
        ...
        <div class="section">
            <div class="first_section">
                ...
                <div class="form-holder">
                    <label id="ar"><b> إضافة وثائق المتطوع </b></label><br>
                    @foreach ( $details as $detail )
                        <a href="/file/{{ $detail->volunteer_id }}/pic" target="_blank">إضافة صورة شخصية</a><br>
                        <a href="/file/{{ $detail->volunteer_id }}/doc" target="_blank">إضافة أي وثائق أخرى</a>
                    @endforeach
                </div>
                ...
                <div class="form-holder">
                  ...
                  <span class="lnr lnr-user"></span>
                  <input type="text" class="form-control" id="family_name" name="Family_Name" value="{{ $volunteer->Family_Name }}" required>
                </div>
                <div class="form-holder">
                  <label id="ar"><b>  اسم الأب</b></label>
                  <label id="en"><b>  Father's name:</b></label>
                  <span class="lnr lnr-user"></span>
                  <input type="text" class="form-control"  id="father_name" name="Father_Name" value="{{ $volunteer->Father_Name }}"required>
                </div>
                <div class="form-holder">
                  <label id="ar"><b>  تاريخ الميلاد</b></label>
                  <label id="en"><b>  Date of Birth:</b></label>
                  <span class="lnr lnr-calendar-full"></span>
                  <input type="date" class="form-control"  id="date_birth" name="Date_Of_Birth" value="{{ $volunteer->Date_Of_Birth }}" required>
                </div>
                <div class="form-holder">
                  <label id="ar"><b>بلد الإقامة: (مثال: سوريا، فلسطين، ..)</b></label>
                  <label id="en"><b>  Country of residence: (Ex: Syria, Cairo, .. )</b></label>
                  <span class="lnr  lnr-map-marker"></span>
                  <input type="text" class="form-control" name="Current_Country" value="{{ $volunteer->Current_Country }}" required>
                </div>
                <div class="form-holder">
                  <label id="ar"><b>  اسم المدينة: (مثال: دمشق، حمص، القاهرة ...)</b></label>
                  <label id="en"><b>  City: (Ex: Aleppo, Homs, .. )</b></label>
                  <span class="lnr  lnr-map-marker"></span>
                  <input type="text" class="form-control" name="Current_City" value="{{ $volunteer->Current_City }}" required>
                </div>
                <div class="form-holder">
                  <label id="ar"><b>  الجنسية: (مثال: سوري، فلسطيني، ..)</b></label>
                  <label id="en"><b>  Nationality: (Ex: Syrian, Egyption, ..)</b></label>
                  <span class="lnr lnr-frame-expand"></span>
                  <input type="text" class="form-control" name="Nationality" value="{{ $volunteer->Nationality }}" required>
                </div>  
            </div>  
        </div>
        ...
        <div class="section">
            <div class="second_section">
                ...
                <div class="form-holder">
                  ...
                  <input type="text" class="form-control" name="Phone_Number" value="{{ $volunteer->Phone_Number }}" required>
                </div>
                <div class="form-holder">
                ...
                <div class="form-holder">
                  ...
                  <input type="text" class="form-control" name="Facebook_Page" value="{{ $volunteer->Facebook_Page }}" required>
                </div>
            </div>
        </div>
        ...
        <div class="section">
            <div class="third_section">
                ...
                <div class="form-holder">
                  ...
                  <input type="text" class="form-control" id="degrees" name="Degree"  value="{{ $volunteer->Degree }}" required>
                </div>
                <div class="form-holder">
                  <label id="ar"><b>  التخصص الدراسي (مثال: اقتصاد) </b></label>
                  <label id="en"><b>  The field of study: (Ex: Economy) </b></label>
                  <span class="lnr lnr-pencil"></span>
                  <input type="text" class="form-control" name="Specialization" value="{{ $volunteer->Specialization }}" required>
                </div>
                <div class="form-holder">
                  ...
                  <input type="text" class="form-control" name="University" value="{{ $volunteer->University }}" required />
                </div>
                <div class="form-holder">
                  <label id="ar"><b>  مستوى اللغة الانجليزية </b></label>
                  <label id="en"><b>  English language level </b></label>
                    <br>
                  <input type="text" class="form-control" name="English_Level" value="{{ $volunteer->English_Level }}" required />
                </div>
            </div>
        </div>
        ...
        <div class="section">
            <div class="forth_section">
                ...
                <div class="form-holder">
                    ...
                    <span class="lnr lnr-user"></span>
                    <input type="text" class="form-control" name="Position" value="{{ $volunteer->Position }}" required>
                </div>
                <div class="form-holder">
                    <label id="ar"><b>  اسم الشركة، المنظمة، المؤسسة التي عملت أو تطوعت بها</b></label>
                    <label id="en"><b>  Organization / company </b></label>
                    <span class="lnr lnr-frame-expand"></span>
                    <input type="text" class="form-control" name="Company" value="{{ $volunteer->Company }}" required>
                </div>
            </div>
        </div>
            ...
            <div class="fifth_section">
              ...
              <div id="en" class="section_name"> Fifth: Volunteering  </div>
                  <div class="form-holder">
                      ...
                      <input type="text" class="form-control" name="Department" value="{{ $volunteer->Department }}" id="departments" required>
                </div>
                <div class="form-holder">
                    ...
                    <input type="text" class="form-control" name="Department_Reason" value="{{ $volunteer->Department_Reason }}" required>
                </div>
                <div class="form-holder">
                    <label id="ar"><b> لماذا ترغب التطوع في المبادرة؟ </b></label>
                    <label id="en"><b> Why do you wish to volunteer with Utopians? </b></label>
                    <span class="lnr  lnr-indent-increase"></span>
                    <input type="text" class="form-control" name="Voluntary_Reason" value="{{ $volunteer->Voluntary_Reason }}" required>
                </div>
                ...
                <div class="form-holder">
                  ...
                  <label id="en"><b>Can you commitment for at least 6 months?   </b></label>
                      <input type="text" class="form-control" value="{{ $volunteer->Six_Months }}" name="Six_Months" required>
                </div>
            </div>
        </div>
              
      <button type="submit">
        <span id="ar"><b>تعديل</b></span>
